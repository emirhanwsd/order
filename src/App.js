    ...
    <div className="w-full max-w-screen-xl space-y-8">
      <div className="flex items-center justify-between">
        ...
        <p className="text-gray-500">
          Order placed{" "}
          <span className="text-gray-900 font-semibold">November 04, 2022</span>
        </p>
      </div>

      <div className="flex flex-col shadow-sm rounded-lg">
        <div className="p-8 border border-b-none rounded-t-lg flex gap-x-8">
          <img
        ...
        <div className="p-8 border border-t-0 rounded-b-lg flex flex-col gap-y-4">
          <p className="font-medium">Preparing to ship on November 04, 2022</p>

          <div className="relative">
            <div className="h-2.5 bg-gray-200 rounded-full" />

            <div className="absolute inset-0 h-2.5 w-[36%] bg-indigo-600 rounded-full z-10" />
          </div>
      ...
      <div className="flex flex-col shadow-sm rounded-lg">
        ...
        <div className="p-8 border border-t-0 rounded-b-lg flex flex-col gap-y-4">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 h-2.5 w-1/6 bg-indigo-600 rounded-full z-10" />
          </div>
